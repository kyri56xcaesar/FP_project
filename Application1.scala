...
//  private val outputPath = hdfsPath + "/results/application1/"
    ...
    private val hdfsURI = "hdfs://clu01.softnet.tuc.gr:8020"
  ...
  //
    ...
    private val application1_input_path = hdfsURI + "/user/chrisa/Reuters"

    private val categories_documents_path = application1_input_path + "/rcv1-v2.topics.qrels"
    private val documents_terms_path = application1_input_path + "/*.dat"
    private val terms_stem_path = application1_input_path + "/stem.termid.idf.map.txt"
